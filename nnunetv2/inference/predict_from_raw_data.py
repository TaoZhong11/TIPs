...
class nnUNetPredictor(object):
    ...
    def predict_single_npy_array(self, input_image: np.ndarray, image_properties: dict,
        ...
        """
        # Check if any dimension exceeds 600
        if any(dim > 600 for dim in input_image.shape):
            print(f'Input image has a dimension greater than 600 and too large for prediction, skipping prediction. Consider to crop and remove unnecessary region. Shape: {input_image.shape}')
            return None
...
if __name__ == '__main__':
    ...
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset003_Liver/imagesTs'),
                                 ...
                                 num_processes_preprocessing=2, num_processes_segmentation_export=1,
